...
const ICONS = {
  home: {
    viewBox: '0 0 24 24',
    path: 'M4 11.5 12 5l8 6.5V20a1.5 1.5 0 0 1-1.5 1.5H5.5A1.5 1.5 0 0 1 4 20zM9.5 21v-6h5v6M7.5 11h9',
  },
  checklist: {
    viewBox: '0 0 24 24',
    path: 'M9 4h6a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zM9 4V3h6v1M9 9l1.5 1.5L13 8M9 14l1.5 1.5L13 13M14 9h4M14 14h4',
  },
  search: {
    viewBox: '0 0 24 24',
    path: 'M11 18a7 7 0 1 0 0-14 7 7 0 0 0 0 14zm8 2-3.5-3.5M11 7v1m0 6v1m-3-3h1m6 0h1',
  },
  community: {
    viewBox: '0 0 24 24',
    path: 'M7.5 11a3 3 0 1 0-3-3 3 3 0 0 0 3 3zm9 0a2.5 2.5 0 1 0-2.5-2.5A2.5 2.5 0 0 0 16.5 11zM3.5 20a5 5 0 0 1 10 0M12.5 20a4 4 0 0 1 8 0',
  },
  menu: {
    viewBox: '0 0 24 24',
  ...
  pin: {
    viewBox: '0 0 24 24',
    path: 'M12 21s6-6.2 6-10a6 6 0 1 0-12 0c0 3.8 6 10 6 10zM12 14a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM12 9.6l.6 1.2 1.4.2-1 1 .2 1.4-1.2-.6-1.2.6.2-1.4-1-1 1.4-.2z',
  },
  star: {
    viewBox: '0 0 24 24',
  ...
  document: {
    viewBox: '0 0 24 24',
    path: 'M7 3h7l5 5v13a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm7 0v5h5M9 12h6M9 16h6',
  },
  upload: {
    viewBox: '0 0 24 24',
  ...
  spark: {
    viewBox: '0 0 24 24',
    path: 'M12 2l1.8 4.8L19 8l-4 3 1.5 5-4.5-3-4.5 3L9 11 5 8l5.2-1.2L12 2zM4 18l1.4 3L8 19l-3-1.2L4 18zm13 1 3 1.2L19 17l-1.2-3-2.3 2L17 19z',
  },
  phone: {
    viewBox: '0 0 24 24',
