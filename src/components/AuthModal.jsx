...
function AuthModal() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Don't close modal - Google will redirect
  }
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-700">
          <h2 className="text-xl font-bold text-white">
            {activeTab === 'sign_in' ? 'Welcome Back!' : 'Join Expat Village'}
          </h2>
          <button 
        ...
        <div className="p-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-medium py-3 rounded-lg transition-colors mb-4 disabled:opacity-50"
          >
